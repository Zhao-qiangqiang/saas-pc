...
@observer
// 销售顾问看板数据
class KanBanSkeleton extends React.Component {
        ...
        return (
            <View style={stylesExample.container}>
                <View>
                    ...
                    <View style={stylesExample.carSeriesChild}>
                        <View style={stylesExample.carSeriesList}>
                            <View>
                                <View style={stylesExample.carSeriesListCarModel}>
                                    <Text style={stylesExample.carModel}> </Text>
                                    <Text style={stylesExample.carModelSale}> </Text>
                                </View>
                                <View>
                        ...
                        <View style={stylesExample.carSeriesListLast}>
                            <View>
                                <View style={stylesExample.carSeriesListCarModel}>
                                    <Text style={stylesExample.carModel}> </Text>
                                    <Text style={stylesExample.carModelSale}> </Text>
